...
export default {
  ...
  methods: {
    ...
    sendZaxira(data, index){
      // localStorage.groupIdInvoice = this.id;
      // localStorage.ruyxatIdIdInvoice = data.ruyxat_id;
      // localStorage.invoiceIdInvoice = data.invoice_id;
      // localStorage.groupDetailsIdInvoice = data.group_detail_id;
      // localStorage
      console.log(data)
      console.log(index)
